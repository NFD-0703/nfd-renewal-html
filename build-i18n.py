...
KO_TEXT = {
    ...
    "Nationwide": "전국",
    "Development Footprint": "개발 지역",
    "Design Energy Efficiency": "설계 에너지 효율",
    ...
    "Hyperscale data center in the Greater Seoul Yongin market": "수도권 용인 권역의 하이퍼스케일 데이터센터",
    ...
    "IT Load": "IT 부하",
    "Cooling": "냉각 방식",
    "Fully air-cooling and liquid-cooling enabled": "공기냉각 및 액체냉각 모두 지원",
    "Fully air-cooling and<br>liquid-cooling enabled": "공기냉각 및 액체냉각<br>모두 지원",
    "Data Hall": "데이터홀",
    "Site Area": "대지 면적",
    ...
    "Full-time": "정규직",
    "Senior": "시니어",
    "Senior Manager / Director, Data Center Investment & Origination": "데이터센터 투자·발굴 매니저/디렉터",
    "Data center investment and origination role": "데이터센터 투자·발굴 포지션",
    "Data center deal origination, financial underwriting, investor negotiation, and transaction execution": "데이터센터 딜 발굴, 재무 분석, 투자자 협상 및 거래 실행",
    ...
    "Required Qualifications": "필수 경험 및 자격",
    "Preferred Qualifications": "우대 자격요건",
    "Location": "근무지",
    ...
    "Seoul headquarters or project sites in the Seoul metro area</strong> (occasional overseas travel may be required)": "서울 본사 또는 수도권 프로젝트 현장</strong> (필요 시 해외 출장 있을 수 있음)",
    ...
    "We are seeking an investment-oriented professional to lead deal origination, deal selection, financial underwriting, investor negotiation, legal document review and transaction execution for data center investment opportunities in Korea. The successful candidate will work closely with global sponsors, investors, local partners, lenders, legal counsel and technical advisors to convert attractive market opportunities into executable transactions.": "한국 내 데이터센터 투자기회에 대한 딜 발굴, 투자대상 선별, 재무 분석, 투자자 협상, 법률문서 검토 및 거래 실행을 주도할 투자형 인재를 찾습니다. 글로벌 스폰서, 투자자, 로컬 파트너, 금융기관 등과 협업하여 유망한 시장 기회를 실행 가능한 거래로 전환하는 역할입니다.",
    "Source data center investment opportunities and build a practical market map": "데이터센터 투자기회 발굴 및 시장 맵핑",
    "Screen opportunities and prepare deal screening memos": "투자대상 선별 및 초기 검토(스크리닝)",
    "Build financial models, conduct IRR analysis, and develop investment theses": "재무모델링, IRR 분석 및 투자논리 수립",
    "Lead investor negotiations and structure transaction terms": "투자자 협상 및 거래 구조화",
    "Review legal documents and negotiate commercial terms": "법률문서 검토 및 상업조건 협상",
    "Manage transaction execution from screening through definitive documentation": "거래 실행 관리(실사~계약 체결)",
    "7–12+ years of experience in PE, real estate/infrastructure investment, investment banking, project finance, or data center development": "PE, 부동산/인프라 투자, IB, 프로젝트파이낸싱, 데이터센터 개발 등 7~12년 이상 경력",
    "Proven ability to originate, screen, analyze, negotiate and execute investment opportunities": "투자기회 발굴·분석·협상·실행 역량",
    "Strong financial modeling and valuation skills (IRR, underwriting, sensitivity analysis, debt/equity structuring)": "IRR 분석, 밸류에이션, Debt/Equity 구조화 등 재무모델링 역량",
    "Experience negotiating with investors, JV partners, or other capital providers": "투자자, JV 파트너 등과의 협상 경험",
    "Experience reviewing commercial terms in legal documents (term sheets, JV agreements, etc.)": "Term Sheet, JV 계약 등 법률문서 상업조건 검토 경험",
    "Understanding of data center development economics (land, power, permitting, etc.)": "데이터센터 개발 경제성(토지, 전력, 인허가 등)에 대한 이해",
    "Excellent Korean and English communication skills": "한국어와 영어 모두 능숙한 커뮤니케이션 능력",
    "Prior experience at a real estate PE fund, infrastructure fund, sovereign wealth fund, investment bank, developer, or data center company": "부동산 PEF, 인프라펀드, 국부펀드, IB, 개발사, 데이터센터사 근무 경험",
    "Direct exposure to data center investment, hyperscale leasing, power procurement, or project financing": "데이터센터/하이퍼스케일 임대, 전력확보, 개발 Underwriting 직접 경험",
    "Existing network among Korean developers, landowners, or financial institutions": "국내 개발사, 토지주, 금융기관 등 네트워크",
    "Experience working with global sponsors or foreign capital investing into Korea": "글로벌 스폰서 또는 해외자본 관련 업무 경험",
    ...
    "Seoul Office": "서울 오피스",
    "9F, 114 Bongeunsa-ro, Gangnam-gu, Seoul, Republic of Korea": "서울특별시 강남구 봉은사로 114, 9층",
    "🚗 Parking Information": "🚗 주차안내",
    "Please use the Yeoksam-dong Nadaeji 3 Parking Lot. (615 Yeoksam-dong, Gangnam-gu, Seoul)": "역삼동 나대지 3 주차장 이용 (서울특별시 강남구 역삼동 615)",
    "Yongin Office": "용인 오피스",
    "3F, 24 Deokseongsandan 2-ro 50beon-gil, Idong-eup, Cheoin-gu, Yongin-si, Gyeonggi-do, Republic of Korea": "경기도 용인시 처인구 이동읍 덕성산단2로50번길 24, 3층",
    ...
    "Large-scale hyperscale programs including Yongin Deokseong-ri IDC, Ansan IDC, and Dangjin IDC are progressing steadily. In particular, Yongin Deokseong-ri IDC is setting a new benchmark in the domestic market with a design PUE of 1.33.": "용인 덕성리 IDC, 안산 IDC, 당진 IDC 등 대규모 하이퍼스케일 프로그램이 안정적으로 진행되고 있습니다. 특히 용인 덕성리 IDC는 design PUE 1.33을 바탕으로 국내 시장의 새로운 기준을 제시하고 있습니다.",
    ...
    "The first and second phases of Dangjin Songsan IDC have also officially moved forward. The program is planned as one of Korea's largest hyperscale data center campuses, designed to meet growing demand from global cloud service providers.": "당진 송산 IDC의 1단계와 2단계도 공식적으로 추진되고 있습니다. 이 프로그램은 글로벌 클라우드 서비스 제공자의 증가하는 수요에 대응하기 위한 국내 최대급 하이퍼스케일 데이터센터 캠퍼스로 계획되고 있습니다.",
        ...
        "@graph": [
            {
                ...
                "address": {
                    "@type": "PostalAddress",
                    "streetAddress": "9F, 114 Bongeunsa-ro",
